...
app.get('/inventory/retrieve/:itemname', (req, res) => { // ### Q4 ### Uncomment the code below and Fix the function call which listens for GET HTTP requests
...
// Add stock route
app.post('/inventory/add', (req, res) => { // ### Q5 ### Uncomment the code below and Fix the function call which listens for POST HTTP requests
...
// Change stock route
app.put('/inventory/change', (req, res) => { // ### Q6 ### Uncomment the code below and Fix the function call which listens for PUT HTTP requests
...
// Remove stock route
app.delete('/inventory/remove/:name', (req, res) => { // ### Q8 ### Uncomment the code below and Fix the function call which listens for DELETE HTTP requests
  const itemIndex = inventory.items.findIndex(item => item.name === req.params.name.trim().toLowerCase()); // ### Q9 ### Also Fix the parameter route, so the item's name can be retrieved correctly
